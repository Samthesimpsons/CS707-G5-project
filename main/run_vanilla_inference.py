...
from models.model import QwenVL, VideoLlava, VideoLLama2

CACHE_DIR = Path("/common/home/projectgrps/CS707/CS707G3/.cache/huggingface/hub")
...
MODEL_PATH = {
    "qwen-vl": "/common/public/Qwen2.5-VL/Qwen2.5-VL-7B-Instruct",
    "video-llava": "LanguageBind/Video-LLaVA-7B-hf",
    "video-llama": "DAMO-NLP-SG/VideoLLaMA2.1-7B-AV"
}
