...
def get_arguments():
    ...
    parser.add_argument("--folder_path", type=str,default="folder path for video.mp4", help="Path to the video file or youtube url")
...
if __name__ == "__main__":
    ...
    video_paths = glob.glob(args.folder_path+"/*.mp4")
    #episodes = ["episode_20"]
    for video_path in video_paths:
        #if any(ep in video_path.lower() for ep in episodes):    
        print(f'Processing {video_path}')
        processed_video_path = goldfish_lv.process_video_url(video_path)
