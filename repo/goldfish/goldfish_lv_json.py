...
class GoldFish_LV:
    ...
    def split_long_video_into_clips(self,video_path):
        ...
        tmp_save_path=f"workspace/tmp/season_1/{self.video_name}"
    ...
    def long_inference_video(self, videos_list,tmp_save_path,subtitle_paths) -> Optional[str]:
        save_long_videos_path = "new_workspace/clips_summary/demo/season_1"
    ...
    def inference(self,video_path, use_subtitles=True, instruction="", number_of_neighbours=3):
        ...
        if video_duration > 180 :
            ...
            file_path=f'new_workspace/clips_summary/demo/season_1/{video_name}.json'
            if not os.path.exists(file_path):
                ...
                subtitle_paths = split_vtt_for_clips(
                    full_vtt_path=f"../main/data/vtt_files/season_1/{self.video_name}.vtt",
                    out_dir=f"workspace/subtitles/season_1/{self.video_name}",
                    clip_duration=80,
            ...
            os.makedirs("new_workspace/embedding/demo/season_1", exist_ok=True)
            os.makedirs("new_workspace/open_ai_embedding/demo/season_1", exist_ok=True)
            if self.args.use_openai_embedding:
                embedding_path=f"new_workspace/open_ai_embedding/demo/season_1/{video_name}.pkl"
            else:
                embedding_path=f"new_workspace/embedding/demo/season_1/{video_name}.pkl"
