...
parser.add_argument('--qa_dir', type=str, default=r"./data/benchmark/episodic_qa_subset/")
parser.add_argument('--tuples_dir', type=str, default=r"./data/benchmark/episodic_tuples/")
